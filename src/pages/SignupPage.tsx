  ...
  return (
    <div style={s.shell}>
      ...
      <style>{`
        ...
        .signup-card-lux { animation: cardEntrance 0.6s cubic-bezier(0.16, 1, 0.3, 1) forwards; }
      ...
      <div className="signup-card-lux" style={s.card}>
        ...
        <p style={s.sub}>انضم إلى ضِيافة لإدارة حجوزاتك</p>
        ...
        <p style={s.loginHint}>
          لديك حساب بالفعل؟ <Link to="/login" className="link-lux" style={s.link}>تسجيل الدخول</Link>
        </p>
      </div>
    </div>
  );
...
const s: Record<string, React.CSSProperties> = {
  ...
  error: {
    ...
    borderRadius: 10, padding: '11px 14px', fontSize: 13, color: '#96432B', marginTop: 12,
  },
  successBox: {
    display: 'flex', alignItems: 'center', gap: 8,
    background: '#EAF5EF', border: '1px solid #BFE3D1',
    borderRadius: 10, padding: '11px 14px', fontSize: 13, color: '#0E5C4A', marginTop: 12,
  },
  btn: {
    marginTop: 24,
    padding: '14px',
  ...
  loginHint: { margin: '20px 0 0', textAlign: 'center', fontSize: 13, color: '#6E7C76', fontWeight: 500 },
  backBtn: {
    background: 'none',
